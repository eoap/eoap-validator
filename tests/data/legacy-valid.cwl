...
$graph:
  ...
  - class: CommandLineTool
    ...
    hints:
      DockerRequirement:
        dockerPull: ghcr.io/terradue/ogc-eo-application-package-hands-on/norm_diff:1.1.7
    baseCommand: ["python", "-m", "app"]
    arguments: []
    inputs:
      rasters:
  ...
  - class: CommandLineTool
    ...
    hints:
      DockerRequirement:
        dockerPull: ghcr.io/terradue/ogc-eo-application-package-hands-on/otsu:1.1.7
    baseCommand: ["python", "-m", "app"]
    arguments: []
    inputs:
      raster:
